    ...
    <section id="features" ref={sectionRef} className="py-20 sm:py-24">
      ...
      >
        ...
        <p className="mt-4 text-lg text-gray-400">
          Diseñado por y para precursores.
        </p>
      </div>
