...
const CTA: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 sm:py-24">
      <div className={`relative bg-[#020202]/30 backdrop-blur-sm rounded-2xl p-8 sm:p-12 text-center gradient-border overflow-hidden transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="relative">
            ...
            Descarga Garden hoy mismo y únete a los precursores que ya están organizando su tiempo de manera más eficiente.
            </p>
            <div className="mt-8">
            <a
                href="#"
